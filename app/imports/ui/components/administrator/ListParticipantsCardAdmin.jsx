...
const ListParticipantCardAdmin = (props) => {
  ...
  /** Render the form. Use Uniforms: https://github.com/vazco/uniforms */
    ...
    const isMinor = props.participants.minor;
    return (
      ...
      <Card id="part-card-page-admin" onMouseEnter={changeBackground} onMouseLeave={onLeave}>
        <Card.Body>
          ...
          <Card.Text>
              ...
              {_.uniq(props.teams).length > 1 ? (<Card.Subtitle>Multiple teams</Card.Subtitle>) : ''}
                      ...
                      <Modal.Body>
                        ...
                        <Row>
                          <Col>
                            ...
                            {_.uniq(props.teams).map((team, i) => <p key={team + i}>{team}</p>)}
                            {props.teams.length === 0 ? (
                              <p> No team </p>) : ''}
                          </Col>
                        </Row>
