          ...
          <Nav className="pr">
            ...
            {this.props.currentUser === '' ? (
              <NavDropdown id="login-dropdown" title="Login">
                <NavDropdown.Item id="login-dropdown-sign-in" as={NavLink} to={ROUTES.SIGN_IN}>
                  Sign In
                </NavDropdown.Item>
              </NavDropdown>
            ) : (
              <NavDropdown id="navbar-current-user" title={this.props.currentUser}>
                <NavDropdown.Item id="navbar-sign-out" as={NavLink} to={ROUTES.SIGN_OUT}>Sign Out</NavDropdown.Item>
                {isParticipant ? (
                  <NavDropdown.Item as={NavLink} to={ROUTES.DELETE_ACCOUNT}>Delete Account</NavDropdown.Item>
                ) : ''}
              </NavDropdown>
            )}
          </Nav>
