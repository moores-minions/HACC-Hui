    ...
    <div>
      <Navbar inverted fixed={'top'} className={'mobileBar'}>
        ...
        >
          ...
          <Offcanvas.Body>
            <div onClick={() => setVisible(!visible)} style={{ padding: '5px' }}>
                  ...
                  {isParticipant ? (
                    [
                      ...
                      <NavDropdown.Item as={NavLink}
                        ...
                        List the Participants ({numParticipants})</NavDropdown.Item>,
                      <NavDropdown.Item as={NavLink}
                                        activeClassName="active"
                                        exact
                  ...
                  {isAdmin ? (
                    [
                      ...
                      <NavDropdown.Item as={NavLink}
                        ...
                        Suggestions List ({suggestionCount})</NavDropdown.Item>,
                      <NavDropdown.Item as={NavLink}
                                        activeClassName="active"
                                        exact
                  ...
                  <NavDropdown.Item>
                    {currentUser === '' ? (
                      <NavDropdown.Item as={NavLink} activeClassName="active" exact to={ROUTES.SIGN_IN}
                                        key={ROUTES.SIGN_IN}
                                        onClick={() => setVisible(!visible)}>Sign In</NavDropdown.Item>
                    ) : (
                      [<NavDropdown.Item as={NavLink} activeClassName="active" exact to={ROUTES.SIGN_OUT}
                                         key={ROUTES.SIGN_OUT}
                                         onClick={() => setVisible(!visible)}>Sign Out</NavDropdown.Item>,
